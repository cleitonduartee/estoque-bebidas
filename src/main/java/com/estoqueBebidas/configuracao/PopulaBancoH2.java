...
public class PopulaBancoH2 implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		produtoService.cadastrarProduto( new ProdutoInsertDTO("Itaipava",Categoria.ALCOOLICA,1,"Cleiton Duarte"));
		produtoService.entradaDeProduto( new ProdutoEntradaSaidaDTO(1,1,"Cleiton Duarte",130.0));
		produtoService.cadastrarProduto(new ProdutoInsertDTO("Suco de Laranja",Categoria.NAOALCOOLICA,2,"Cleiton Duarte"));
		produtoService.cadastrarProduto(new ProdutoInsertDTO("Suco de Uva",Categoria.NAOALCOOLICA,2,"Cleiton Duarte"));
		produtoService.entradaDeProduto(new ProdutoEntradaSaidaDTO(3,2,"Cleiton Duarte",255.0));
		produtoService.cadastrarProduto(new ProdutoInsertDTO("Coca-Cola",Categoria.NAOALCOOLICA,3,"Cleiton Duarte"));
		produtoService.cadastrarProduto(new ProdutoInsertDTO("Fanta",Categoria.NAOALCOOLICA,3,"Cleiton Duarte"));
		...
		produtoService.cadastrarProduto(new ProdutoInsertDTO("Red Bull",Categoria.NAOALCOOLICA,5,"Cleiton Duarte"));
		produtoService.cadastrarProduto(new ProdutoInsertDTO("Monster",Categoria.NAOALCOOLICA,5,"Cleiton Duarte"));
		produtoService.cadastrarProduto(new ProdutoInsertDTO("Fusion",Categoria.NAOALCOOLICA,5,"Cleiton Duarte"));
		...
		produtoService.cadastrarProduto(new ProdutoInsertDTO( "Vinho Suave",Categoria.ALCOOLICA,4,"Cleiton Duarte"));
